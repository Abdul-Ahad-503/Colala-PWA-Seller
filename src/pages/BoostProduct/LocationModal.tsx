...
const LocationModal: React.FC<LocationModalProps> = ({
  ...
  const filteredData = nigerianStates.filter(item =>
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 backdrop-brightness-50 bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-3xl w-[430px] h-[750px] flex flex-col">
          {/* Header */}
          <div className="flex items-center justify-center pop_up relative p-6 pb-4 mb-4">
            ...
            >
              <img src={IMAGES.Xcircle} alt="Close" className="w-5 h-5 -mt-4 ml-75" />
            </button>
          </div>

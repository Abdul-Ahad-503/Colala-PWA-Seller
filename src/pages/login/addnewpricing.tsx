    ...
    <div className="fixed inset-0 backdrop-brightness-50 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-[#F9F9F9] rounded-3xl w-[430px] h-[426px] flex flex-col">
        ...
        <div className="flex items-center justify-center pop_up relative p-6 pb-4 mb-4">
          ...
          >
           <img src="/public/Vector.svg" alt="Close" className="w-5 h-5 ml-4 -mt-4" />
          </button>
        </div>
        ...
        <div className="px-6 pb-6 space-y-4">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <div className="relative">
                <input
                  ...
                  className="sr-only"
                />
                <div className={`w-5 h-5 rounded ${isFreeDelivery ? 'bg-primary' : 'bg-white border-2 border-gray-300'} flex items-center justify-center`}>
                  {isFreeDelivery && (
          ...
          <div className="pt-4">
            <button
              onClick={handleSave}
              className="w-full bg-primary text-white font-sm py-4 px-6 rounded-xl transition-colors  text-[14px]"
            >
              Save
            </button>
          </div>

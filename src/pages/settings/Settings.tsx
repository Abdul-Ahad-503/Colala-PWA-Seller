        ...
        <div className="w-[390px] rounded-3xl  flex flex-col gap-3 text-gray-900">
          {/* Profile section */}
            ...
            <div className="flex flex-col gap-2">
              <button onClick={() => navigate('/settings/My-Products')} className="flex items-center bg-[#E53E3E] rounded-2xl px-0 shadow-sm relative text-left w-full">
              ...
              <button onClick={() => navigate('/settings/analytics')} className="flex items-center bg-[#E53EE2] rounded-2xl px-0 shadow-sm relative text-left">
              ...
              <button onClick={() => navigate('/settings/subscriptions')} className="flex items-center bg-[#62e53e] rounded-2xl px-0 shadow-sm relative text-left w-full">
              ...
              <button onClick={() => navigate('/settings/manage-coupons')} className="flex items-center bg-[#E5863E] rounded-2xl px-0 shadow-sm relative text-left w-full">
              ...
              <button onClick={() => navigate('/settings/announcements')} className="flex items-center bg-[#4c7ee5] rounded-2xl px-0 shadow-sm relative text-left w-full">
              ...
              <button onClick={() => navigate('/settings/reviews')} className="flex items-center bg-[#E53E3E] rounded-2xl px-0 shadow-sm relative text-left w-full">
              ...
              <button onClick={() => navigate('/settings/referrals')} className="flex items-center bg-[#6c3ee5] rounded-2xl px-0 shadow-sm relative text-left w-full">
